...
const ContactsForm = () => {
  ...
  const notify = () => toast.error(`S'il vous plaît, remplissez le champ de texte`, {
    className: style.errorMessage,
  });
  const confirmation = () => toast.success(`Votre message a été envoyé avec succès`, {
        ...
        <div className={style.form} id="contacts">
          <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <textarea className={style.form__comment} name="message" id="message" cols="30" rows="10" value={message} onChange={(event) => setMessage(event.target.value)}></textarea>
            </div>
